  ...
  <section>
    <div class="grid grid-cols-7 min-h-screen items-center sm:gap-4">
      ...
      <div class="
        ...
        <div>
          <p class="text-h2xl text-leny-cyan-400 sm:text-leny-blue-800 font-futura-ptmedium mb-6">Rejected</p>
          <p class="text-sm sm:text-base text-white sm:text-leny-gray-800 font-futura-ptmedium mb-3">Payment not submitted</p>
          <p class="text-xs sm:text-sm text-white sm:text-leny-gray-800 font-futura-ptbook">“Please check your mail”</p>
