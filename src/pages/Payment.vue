    ...
    <div class="grid grid-cols-7 min-h-screen items-center sm:gap-4">
      <div class="sm:flex items-center justify-center sm:min-h-screen col-start-1 col-end-8 sm:col-start-1 sm:col-end-4 bg-dark-login-image bg-center bg-no-repeat bg-cover">
        <div class="lg:w-4/5 py-12 px-4 lg:px-0 lg:py-0">
          ...
          <div>
            <span class="text-white text-base block font-futura-ptbook">Try Leny Standard</span>
            <h1 class="text-white text-h2xl lg:text-h1xl font-futura-ptmedium mb-0">
              14 days free
            </h1>
            <span class="text-white text-base block mb-14 font-futura-ptbook">Then 89 € per month</span>
            <p class="flex justify-between mb-3 font-futura-ptbook">
            ...
            <p class="flex justify-between mb-4 font-futura-ptbook">
      ...
      <div class="col-start-1 col-end-8 sm:col-start-4 sm:col-end-8 sm:min-h-screen flex flex-col justify-center mx-auto w-full lg:w-3/4 pr-4 lg:pr-0 pl-4 sm:pl-0 py-6 sm:py-0">
        <p class="text-h2xl sm:text-h2xl font-futura-ptmedium text-leny-blue-800 pb-5 before:leny-gray-700 before:border-leny-gray-600 relative before:w-11 before:border-b before:absolute before:bottom-0 before:inset-x-0 mb-10">
          Payment details
        </p>
        <form action="">
          <div class="relative">
