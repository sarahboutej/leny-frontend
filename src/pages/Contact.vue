<template>
  ...
  <section class="banner-wrapper mt-[5.5rem] bg-contact-banner bg-no-repeat bg-cover bg-center">
    <div class="container mx-auto h-52 md:h-80 flex flex-col align-center justify-center">
      <h1 class="text-white text-h2xl md:text-h1xl uppsercase text-center font-futura-ptmedium">Contact Us</h1>
    </div>
  </section>
    ...
    <div class="container mx-auto">
      <div class="grid md:grid-cols-5 grid-rows-1 gap-6">
        <div class="md:col-start-1 md:col-end-3">
          <p class="text-2xl font-futura-ptmedium text-leny-blue-800 pb-5 mb-6">
            Contact information
          </p>
          <ul class="">
            <li class="flex mb-4">
          ...
          <p class="text-sm text-leny-blue-500 mt-8 mb-4 font-futura-ptbook">For more information please contact us:</p>
          <form action="">
            <div class="relative">
